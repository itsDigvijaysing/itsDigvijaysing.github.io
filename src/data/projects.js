...
const projects = [
  {
    ...
    private: false,
    overview:
      'Multi-tenant customer-care platform handling support, sales, and marketing across voice, WhatsApp, email, and SMS. Hybrid RAG with LLM intent classification improved answer relevance by 18%. Deployed for partners including IIT Hyderabad and ITIC Incubator.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Full-stack legal assistant with intent routing to Criminal, Civil, Constitutional, or General agents. RAG Fusion (n=3) over ~2,600 chunks from six statute PDFs. Groq Llama 3.3 70B synthesis with cited JSON responses.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Async agent stack on Chrome DevTools Protocol. Configurable LLMs plan actions from DOM/accessibility state; modular watchdogs handle downloads, popups, and crashes. Work at Samsung SRIB improved task success rate by 400% and reduced token payload by 40%.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Human activity classification on PIRvision low-energy sensor data. CNN–LSTM hybrid with 12+ engineered temporal features, noise injection, and class balancing outperformed MLP and GRU baselines.',
    highlights: [
  ...
  },
  {
    ...
    private: true,
    overview:
      'Evaluated adversarial robustness of Florence-2-Base on COCO under FGSM and PGD attacks. Retraining-free defense pipeline using input and feature-level transformations recovered ~30% performance under attack.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Anime-inspired RPG status app in Kotlin 2.1 and Jetpack Compose. Six stats on a hexagon radar, E-to-S rank progression, 28-day streak calendar, and optional Todoist sync every 15 minutes.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Issue viewer plus AI ticket generator. Free-form requirements become 3–5 dev subtasks with matching test cases. API key rotation and JSON validation for rate-limit resilience.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Local conversational voice agent: Whisper transcription, Ollama LLM, Suno Bark synthesis. LangChain memory, YAML config, structured logging. Typical latency 5–12s on consumer hardware.',
    highlights: ['Zero cloud API dependency', 'LangChain conversation memory', 'YAML-driven configuration'],
  ...
  },
  {
    ...
    private: false,
    overview:
      'Hybrid app for students to browse nearby mess and tiffin services, view daily menus, and place orders. Containerized and deployed to Azure App Service during Microsoft Future Ready Talent internship.',
    highlights: ['React Native + Node.js on Azure', 'Azure App Service with CI/CD pipelines', 'MongoDB + Blob Storage backend'],
  ...
  },
  {
    ...
    private: false,
    overview:
      'GNOME Shell extension (45–50) bringing macOS Stage Manager organization to Linux. Groups, Apps, and Workspaces modes with live hover previews and configurable sidebar.',
    highlights: ['Wayland and X11 support', '3D perspective sidebar with hover previews', 'Installable via GNOME Extensions'],
  ...
  },
  {
    ...
    private: false,
    overview:
      'IIT Hyderabad course project. Compact local Qwen3 handles tool selection; SARVAM-M generates responses in English, Hindi, or Telugu. Enhanced prompting achieved 0.79 tool accuracy without fine-tuning.',
    highlights: [
  ...
  },
  {
    ...
    private: false,
    overview:
      'Built at Cognizant to automate Apex security remediation. Parses SOQL, enforces USER_MODE FLS, pre-checks CRUD on DML, applies sharing settings, and strips debug statements.',
    highlights: ['SOQL injection and FLS/CRUD auto-fix', 'Downloadable patched output', 'Reduced manual security review cycles'],
  ...
  },
  {
    ...
    private: false,
    overview:
      'Full-stack image generation web application pairing a React frontend with Django backend and Stable Diffusion inference.',
...
// 'YYYY-MM' → 'Apr 2026' for display (raw string stays for sorting/data).
